...
router.get('/quiz/quizLevelAnalysis', function (req,res,next) {
    var user = req.session.user;
    var data = {};
    if(user){
        var paras = {};
        ...
        var url = base + "student/quiz/quizLevelAnalysis?&quiz_id="+paras.quiz_id+"&id="+paras.id+"&token="+paras.token;
        request.get(url, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                // console.log(body);
                var parsed = JSON.parse(body);
...
router.get('/quiz/overallLevelAnalysis', function (req,res,next) {
    var user = req.session.user;
    var data = {};
    if(user){
        var paras = {};
        ...
        var url = base + "student/quiz/overallFeedback?&quiz_id="+paras.quiz_id+"&id="+paras.id+"&token="+paras.token;
        request.get(url, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                // console.log(body);
                var parsed = JSON.parse(body);
...
router.get('/quiz/oneRecord', function (req,res,next) {
    var user = req.session.user;
    var data = {};
    if(user){
        var paras = {};
        ...
        var url = base + "student/answer/get?&quiz_question_id="+paras.quiz_question_id+"&id="+paras.id+"&token="+paras.token;
        request.get(url, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                // console.log(body);
                var parsed = JSON.parse(body);
